...
def main():
    ...
    # Load data
    try:
        X_train = pd.read_csv("hf://datasets/dr-psych/tourism_project/X_train.csv")
        X_test = pd.read_csv("hf://datasets/dr-psych/tourism_project/X_test.csv")
        y_train = pd.read_csv("hf://datasets/dr-psych/tourism_project/y_train.csv").iloc[:, 0]
        y_test = pd.read_csv("hf://datasets/dr-psych/tourism_project/y_test.csv").iloc[:, 0]
